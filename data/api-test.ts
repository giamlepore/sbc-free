export const basicQuestions = [
  ...
  },
  {
    id: 4,
    question:
      "Imagine que sua equipe precisa integrar uma API de pagamento ao produto. O que você deve validar antes de iniciar a integração?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Ao revisar a documentação de uma API, você encontra as seguintes informações: GET /users/{id}. O que significa essa chamada?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "Seu time reporta que a integração com uma API está retornando erros 404. O que você deveria questionar primeiro?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "Como você pode monitorar a eficiência de uma integração com uma API?",
    options: [
  ...
  },
  {
    id: 9,
    question:
      "Uma API solicita autenticação via OAuth 2.0. Qual é o papel do access token nesse processo?",
    options: [
  ...
  },
  {
    id: 11,
    question:
      "Um cliente reporta que os dados de um relatório no produto estão desatualizados. Após investigação, você descobre que eles dependem de uma API externa. Como você lidaria com isso?",
    options: [
  ...
  },
  {
    id: 12,
    question:
      "Sua equipe propõe criar uma API para um parceiro comercial. Como PM, qual seria sua principal responsabilidade nesse projeto?",
    options: [
...
export const intermediateQuestions = [
  ...
  },
  {
    id: 2,
    question:
      "Quais são as características fundamentais que definem uma API RESTful?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "Sua equipe está consumindo uma API que retorna o seguinte erro: 401 Unauthorized. O que isso significa?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Durante a análise de uma nova API de parceiros, você percebe que ela tem uma limitação de 100 requisições por minuto. Qual seria uma solução prática para contornar esse problema?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "Ao revisar a documentação de uma API, você vê a seguinte chamada: PUT /orders/{orderId}. O que esse endpoint faz?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "Qual das opções abaixo não é uma métrica relevante para o desempenho de uma API?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      "Se uma API expõe informações sensíveis, qual das alternativas abaixo é a prática de segurança mais recomendada?",
    options: [
  ...
  },
  {
    id: 11,
    question:
      "Sua equipe precisa decidir se vai usar uma API interna ou construir uma API própria. Como Product Manager, o que você deve considerar antes de tomar essa decisão?",
    options: [
  ...
  },
  {
    id: 12,
    question:
      "Durante a integração com uma nova API, o cliente final solicita que as atualizações de dados sejam quase em tempo real. Qual estratégia de integração você recomendaria?",
    options: [
...
export const advancedQuestions = [
  {
    id: 1,
    question:
      "Em relação a APIs REST, qual das seguintes opções está incorreta?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Durante a integração com uma API de terceiros, o fornecedor comunica que o contrato da API será alterado e o campo "status" (que era um boolean) agora será uma "string". O que você deve fazer?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      "Sua equipe está consumindo uma API de clima e os dados de temperatura estão inconsistentes. Algumas requisições retornam 200 OK, mas os dados estão desatualizados. O que você investigaria primeiro?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "Sua equipe está usando chaves de API para autenticar usuários, mas o time de segurança está sugerindo mudar para OAuth 2.0. Quais são as vantagens de OAuth 2.0?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Sua API de pagamento parou de funcionar e o fornecedor afirma que a API foi "deprecated" sem aviso prévio. Qual é a melhor forma de minimizar o impacto no curto prazo?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      "Sua equipe precisa expor uma API pública, mas a segurança é uma preocupação. Quais práticas você recomendaria para garantir que a API seja segura?",
    options: [
  ...
  },
  {
    id: 9,
    question:
      "O fornecedor de uma API crítica aumentou os preços em 75%. Como você apresentaria uma proposta de renegociação?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      "Sua equipe identificou que 40% dos custos operacionais vêm da dependência de uma API de terceiros. Quais ações você sugeriria para reduzir os custos?",
    options: [
...
export const feedbackDatabase: {
  [key: string]: { [key: number]: FeedbackInfo };
} = {
  basic: {
    1: {
      whyImportant: [
