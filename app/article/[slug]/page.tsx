        ...
        <article className="max-w-3xl mx-auto px-4">
          <ReactMarkdown
            ...
            components={{
              h1: ({ ...props }) => (
                <h1
                  className="text-4xl font-bold mb-4 mt-8 text-gray-200"
                  {...props}
                />
              ),
              h2: ({ ...props }) => (
                <h2
                  className="text-3xl font-semibold mb-3 mt-6 text-gray-300"
                  {...props}
                />
              ),
              h3: ({ ...props }) => (
                <h3
                  className="text-2xl font-medium mb-2 mt-4 text-gray-300"
                  {...props}
                />
              ),
              p: ({ ...props }) => (
              ...
              ul: ({ ...props }) => (
                <ul
                  className="list-disc list-inside mb-4 pl-4 text-gray-300"
                  {...props}
                />
              ),
              ol: ({ ...props }) => (
                <ol
                  className="list-decimal list-inside mb-4 pl-4 text-gray-300"
                  {...props}
                />
              ),
              img: ({ ...props }) => (
              ...
              pre: ({ ...props }) => (
                <pre
                  className="bg-gray-800 rounded p-4 overflow-x-auto my-4 text-gray-300"
                  {...props}
                />
              ),
            }}
